                ...
                <CardContent className="flex flex-1 flex-col items-center gap-4">
                  ...
                  <div className="mt-auto flex w-full flex-col items-center gap-4">
                    <div className="rounded-lg border-2 border-border bg-background p-4">
                      <Image
                        src="/discord-qr-code-placeholder.jpg"
                        alt="Discord QR Code"
                        width={150}
                        height={150}
                        className="mx-auto"
                      />
                      <p className="mt-2 text-center text-xs text-muted-foreground">Scan to join</p>
                    </div>
              ...
              <Card className="flex flex-col border-primary/20 hover:border-primary hover:shadow-lg transition-all">
                ...
                <CardContent className="flex flex-1 flex-col items-center gap-4">
                  ...
                  <div className="mt-auto flex w-full flex-col items-center gap-4">
                    <div className="rounded-lg border-2 border-border bg-background p-4">
                      <Image
                        src="/instagram-qr-code-placeholder.jpg"
                        alt="Instagram QR Code"
                        width={150}
                        height={150}
                        className="mx-auto"
                      />
                      <p className="mt-2 text-center text-xs text-muted-foreground">Scan to follow</p>
                    </div>
                    <Button asChild variant="outline" className="w-full bg-transparent">
                      <a href="#" target="_blank" rel="noopener noreferrer">
